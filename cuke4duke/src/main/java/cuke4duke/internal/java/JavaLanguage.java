...
public class JavaLanguage extends ProgrammingLanguage {
  ...
  public LanguageMixin languageMixin;
  @SuppressWarnings("unchecked") public JavaLanguage(  LanguageMixin languageMixin) throws Throwable {
  ...
  public void load(  String java_file) throws ClassNotFoundException {
  ...
  public Class<?> loadClass(  String javaPath) throws ClassNotFoundException {
  ...
  public void registerStepDefinitionsFor(  Class<?> clazz){
  ...
  public void registerStepDefinitionMaybe(  Method method){
  ...
  public void registerBeforeMaybe(  Method method){
  ...
  public void registerAfterMaybe(  Method method){
